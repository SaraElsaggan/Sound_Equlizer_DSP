...
"")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.signal_view.sizePolicy().hasHeightForWidth())
        self.signal_view.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.windows_tabs.sizePolicy().hasHeightForWidth())
        self.windows_tabs.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setBold(True)
...
"font-weight: bold;}")
        ...
        self.windows_tabs.setCurrentIndex(1)
