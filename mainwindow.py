...
"")
        ...
        self.std_lbl = QtWidgets.QLabel(self.Gaussian_window)
        self.std_lbl.setObjectName("std_lbl")
        self.horizontalLayout.addWidget(self.std_lbl)
        self.std_slider = QtWidgets.QSlider(self.Gaussian_window)
        self.std_slider.setMaximum(2000)
        self.std_slider.setProperty("value", 1000)
        self.std_slider.setOrientation(QtCore.Qt.Horizontal)
        self.std_slider.setObjectName("std_slider")
        self.horizontalLayout.addWidget(self.std_slider)
...
"font-weight: bold;}")
        ...
        self.range_4_slider.setMinimum(-50)
        self.range_4_slider.setMaximum(50)
        self.range_4_slider.setProperty("value", 0)
        self.range_4_slider.setOrientation(QtCore.Qt.Vertical)
        self.range_4_slider.setObjectName("range_4_slider")
        self.verticalLayout_9.addWidget(self.range_4_slider)
        self.range_4_lbl = QtWidgets.QLabel(self.uniform_page)
        self.range_4_lbl.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        self.range_4_lbl.setText("")
        self.range_4_lbl.setObjectName("range_4_lbl")
        self.verticalLayout_9.addWidget(self.range_4_lbl)
        ...
        self.range_1_slider.setMinimum(-50)
        self.range_1_slider.setMaximum(50)
        self.range_1_slider.setProperty("value", 0)
        self.range_1_slider.setOrientation(QtCore.Qt.Vertical)
        self.range_1_slider.setObjectName("range_1_slider")
        self.verticalLayout_6.addWidget(self.range_1_slider)
        self.range_1_lbl = QtWidgets.QLabel(self.uniform_page)
        self.range_1_lbl.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        self.range_1_lbl.setText("")
        self.range_1_lbl.setObjectName("range_1_lbl")
        self.verticalLayout_6.addWidget(self.range_1_lbl)
        self.gridLayout.addLayout(self.verticalLayout_6, 0, 0, 1, 1)
        self.verticalLayout_12 = QtWidgets.QVBoxLayout()
        self.verticalLayout_12.setObjectName("verticalLayout_12")
        self.range_7_slider = QtWidgets.QSlider(self.uniform_page)
        self.range_7_slider.setMinimum(-50)
        self.range_7_slider.setMaximum(50)
        self.range_7_slider.setProperty("value", 0)
        self.range_7_slider.setOrientation(QtCore.Qt.Vertical)
        self.range_7_slider.setObjectName("range_7_slider")
        self.verticalLayout_12.addWidget(self.range_7_slider)
        self.range_7_lbl = QtWidgets.QLabel(self.uniform_page)
        self.range_7_lbl.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        self.range_7_lbl.setText("")
        self.range_7_lbl.setObjectName("range_7_lbl")
        self.verticalLayout_12.addWidget(self.range_7_lbl)
        self.gridLayout.addLayout(self.verticalLayout_12, 0, 6, 1, 1)
        self.verticalLayout_14 = QtWidgets.QVBoxLayout()
        self.verticalLayout_14.setObjectName("verticalLayout_14")
        self.range_9_slider = QtWidgets.QSlider(self.uniform_page)
        self.range_9_slider.setMinimum(-50)
        self.range_9_slider.setMaximum(50)
        self.range_9_slider.setProperty("value", 0)
        self.range_9_slider.setOrientation(QtCore.Qt.Vertical)
        self.range_9_slider.setObjectName("range_9_slider")
        self.verticalLayout_14.addWidget(self.range_9_slider)
        self.range_9_lbl = QtWidgets.QLabel(self.uniform_page)
        self.range_9_lbl.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        self.range_9_lbl.setText("")
        self.range_9_lbl.setObjectName("range_9_lbl")
        self.verticalLayout_14.addWidget(self.range_9_lbl)
        self.gridLayout.addLayout(self.verticalLayout_14, 0, 8, 1, 1)
        self.verticalLayout_11 = QtWidgets.QVBoxLayout()
        self.verticalLayout_11.setObjectName("verticalLayout_11")
        self.range_6_slider = QtWidgets.QSlider(self.uniform_page)
        self.range_6_slider.setMinimum(-50)
        self.range_6_slider.setMaximum(50)
        self.range_6_slider.setProperty("value", 0)
        self.range_6_slider.setSliderPosition(0)
        self.range_6_slider.setOrientation(QtCore.Qt.Vertical)
        self.range_6_slider.setObjectName("range_6_slider")
        self.verticalLayout_11.addWidget(self.range_6_slider)
        self.range_6_lbl = QtWidgets.QLabel(self.uniform_page)
        self.range_6_lbl.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        self.range_6_lbl.setText("")
        self.range_6_lbl.setObjectName("range_6_lbl")
        self.verticalLayout_11.addWidget(self.range_6_lbl)
        ...
        self.range_2_slider.setMinimum(-50)
        self.range_2_slider.setMaximum(50)
        self.range_2_slider.setProperty("value", 0)
        self.range_2_slider.setOrientation(QtCore.Qt.Vertical)
        self.range_2_slider.setObjectName("range_2_slider")
        self.verticalLayout_7.addWidget(self.range_2_slider)
        self.range_2_lbl = QtWidgets.QLabel(self.uniform_page)
        self.range_2_lbl.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        self.range_2_lbl.setText("")
        self.range_2_lbl.setObjectName("range_2_lbl")
        self.verticalLayout_7.addWidget(self.range_2_lbl)
        ...
        self.range_8_slider.setMinimum(-50)
        self.range_8_slider.setMaximum(50)
        self.range_8_slider.setProperty("value", 0)
        self.range_8_slider.setOrientation(QtCore.Qt.Vertical)
        self.range_8_slider.setObjectName("range_8_slider")
        self.verticalLayout_13.addWidget(self.range_8_slider)
        self.range_8_lbl = QtWidgets.QLabel(self.uniform_page)
        self.range_8_lbl.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        self.range_8_lbl.setText("")
        self.range_8_lbl.setObjectName("range_8_lbl")
        self.verticalLayout_13.addWidget(self.range_8_lbl)
        self.gridLayout.addLayout(self.verticalLayout_13, 0, 7, 1, 1)
        self.verticalLayout_10 = QtWidgets.QVBoxLayout()
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.range_5_slider = QtWidgets.QSlider(self.uniform_page)
        self.range_5_slider.setMinimum(-50)
        self.range_5_slider.setMaximum(50)
        self.range_5_slider.setProperty("value", 0)
        self.range_5_slider.setOrientation(QtCore.Qt.Vertical)
        self.range_5_slider.setObjectName("range_5_slider")
        self.verticalLayout_10.addWidget(self.range_5_slider)
        self.range_5_lbl = QtWidgets.QLabel(self.uniform_page)
        self.range_5_lbl.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        self.range_5_lbl.setText("")
        self.range_5_lbl.setObjectName("range_5_lbl")
        self.verticalLayout_10.addWidget(self.range_5_lbl)
        ...
        self.range_3_slider.setMinimum(-50)
        self.range_3_slider.setMaximum(50)
        self.range_3_slider.setProperty("value", 0)
        self.range_3_slider.setOrientation(QtCore.Qt.Vertical)
        self.range_3_slider.setObjectName("range_3_slider")
        self.verticalLayout_8.addWidget(self.range_3_slider)
        self.range_3_lbl = QtWidgets.QLabel(self.uniform_page)
        self.range_3_lbl.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        self.range_3_lbl.setText("")
        self.range_3_lbl.setObjectName("range_3_lbl")
        self.verticalLayout_8.addWidget(self.range_3_lbl)
        ...
        self.range_10_slider.setMinimum(-50)
        self.range_10_slider.setMaximum(50)
        self.range_10_slider.setProperty("value", 0)
        self.range_10_slider.setOrientation(QtCore.Qt.Vertical)
        self.range_10_slider.setObjectName("range_10_slider")
        self.verticalLayout_15.addWidget(self.range_10_slider)
        self.range_10_lbl = QtWidgets.QLabel(self.uniform_page)
        self.range_10_lbl.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        self.range_10_lbl.setText("")
        self.range_10_lbl.setObjectName("range_10_lbl")
        self.verticalLayout_15.addWidget(self.range_10_lbl)
        self.gridLayout.addLayout(self.verticalLayout_15, 0, 9, 1, 1)
        ...
        self.triangle_slider = QtWidgets.QSlider(self.music_page)
        self.triangle_slider.setMinimum(-50)
        self.triangle_slider.setMaximum(50)
        self.triangle_slider.setProperty("value", 1)
        self.triangle_slider.setOrientation(QtCore.Qt.Vertical)
        self.triangle_slider.setObjectName("triangle_slider")
        self.verticalLayout_26.addWidget(self.triangle_slider)
        self.label_35 = QtWidgets.QLabel(self.music_page)
        self.label_35.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        ...
        self.voil_slider.setMinimum(-50)
        self.voil_slider.setMaximum(50)
        self.voil_slider.setProperty("value", 0)
        ...
        self.label_36.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        ...
        self.piano_slider.setMinimum(-50)
        self.piano_slider.setMaximum(50)
        self.piano_slider.setProperty("value", 0)
        ...
        self.label_37.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        ...
        self.xylophone_slider = QtWidgets.QSlider(self.music_page)
        self.xylophone_slider.setMinimum(-50)
        self.xylophone_slider.setMaximum(50)
        self.xylophone_slider.setProperty("value", 0)
        self.xylophone_slider.setOrientation(QtCore.Qt.Vertical)
        self.xylophone_slider.setObjectName("xylophone_slider")
        self.verticalLayout_29.addWidget(self.xylophone_slider)
        ...
        self.horse_slider = QtWidgets.QSlider(self.animal_page)
        self.horse_slider.setMinimum(-50)
        self.horse_slider.setMaximum(50)
        ...
        self.verticalLayout_30.addWidget(self.horse_slider)
        self.label_39 = QtWidgets.QLabel(self.animal_page)
        self.label_39.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        ...
        self.bat_slider = QtWidgets.QSlider(self.animal_page)
        self.bat_slider.setMinimum(-50)
        self.bat_slider.setMaximum(50)
        self.bat_slider.setProperty("value", 0)
        self.bat_slider.setOrientation(QtCore.Qt.Vertical)
        self.bat_slider.setObjectName("bat_slider")
        self.verticalLayout_31.addWidget(self.bat_slider)
        self.label_40 = QtWidgets.QLabel(self.animal_page)
        self.label_40.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        ...
        self.wolf_slider = QtWidgets.QSlider(self.animal_page)
        self.wolf_slider.setMinimum(-50)
        self.wolf_slider.setMaximum(50)
        ...
        self.verticalLayout_32.addWidget(self.wolf_slider)
        self.label_45 = QtWidgets.QLabel(self.animal_page)
        self.label_45.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        ...
        self.duck_slider.setMinimum(-50)
        self.duck_slider.setMaximum(50)
        self.duck_slider.setProperty("value", 0)
        self.duck_slider.setOrientation(QtCore.Qt.Vertical)
        self.duck_slider.setObjectName("duck_slider")
        self.verticalLayout_33.addWidget(self.duck_slider)
        self.label_46 = QtWidgets.QLabel(self.animal_page)
        self.label_46.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        ...
        self.arthmya_1_slider.setMinimum(-50)
        self.arthmya_1_slider.setMaximum(50)
        self.arthmya_1_slider.setProperty("value", 0)
        ...
        self.label_41.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        ...
        self.arthmya_2_slider.setMinimum(-50)
        self.arthmya_2_slider.setMaximum(50)
        self.arthmya_2_slider.setProperty("value", 0)
        ...
        self.label_42.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        ...
        self.arthmya_3_slider.setMinimum(-50)
        ...
        self.label_49.setStyleSheet("font: 700 10pt \"Segoe UI\";")
        ...
        MainWindow.setTabOrder(self.combo_bx_mode, self.range_1_slider)
        MainWindow.setTabOrder(self.range_1_slider, self.range_2_slider)
        MainWindow.setTabOrder(self.range_2_slider, self.range_3_slider)
        MainWindow.setTabOrder(self.range_3_slider, self.range_4_slider)
        MainWindow.setTabOrder(self.range_4_slider, self.range_5_slider)
        MainWindow.setTabOrder(self.range_5_slider, self.range_6_slider)
        MainWindow.setTabOrder(self.range_6_slider, self.range_7_slider)
        MainWindow.setTabOrder(self.range_7_slider, self.range_8_slider)
        MainWindow.setTabOrder(self.range_8_slider, self.range_9_slider)
        MainWindow.setTabOrder(self.range_9_slider, self.range_10_slider)
        MainWindow.setTabOrder(self.range_10_slider, self.triangle_slider)
        MainWindow.setTabOrder(self.triangle_slider, self.voil_slider)
        MainWindow.setTabOrder(self.voil_slider, self.piano_slider)
        MainWindow.setTabOrder(self.piano_slider, self.xylophone_slider)
        MainWindow.setTabOrder(self.xylophone_slider, self.horse_slider)
        MainWindow.setTabOrder(self.horse_slider, self.bat_slider)
        MainWindow.setTabOrder(self.bat_slider, self.wolf_slider)
        MainWindow.setTabOrder(self.wolf_slider, self.duck_slider)
        MainWindow.setTabOrder(self.duck_slider, self.arthmya_1_slider)
        MainWindow.setTabOrder(self.arthmya_1_slider, self.arthmya_2_slider)
        MainWindow.setTabOrder(self.arthmya_2_slider, self.arthmya_3_slider)
        MainWindow.setTabOrder(self.arthmya_3_slider, self.graphicsView_gaussian)
        MainWindow.setTabOrder(self.graphicsView_gaussian, self.chek_bx_show_spect_input)
        MainWindow.setTabOrder(self.chek_bx_show_spect_input, self.chek_bx_show_spect_output)
        MainWindow.setTabOrder(self.chek_bx_show_spect_output, self.btn_play_input)
        MainWindow.setTabOrder(self.btn_play_input, self.btn_pause_input)
        MainWindow.setTabOrder(self.btn_pause_input, self.btn_zoom_in_input)
        MainWindow.setTabOrder(self.btn_zoom_in_input, self.btn_fast_input)
        MainWindow.setTabOrder(self.btn_fast_input, self.btn_slow_input)
        MainWindow.setTabOrder(self.btn_slow_input, self.signal_view)
        MainWindow.setTabOrder(self.signal_view, self.windows_tabs)
        MainWindow.setTabOrder(self.windows_tabs, self.graphicsView_hamming)
        MainWindow.setTabOrder(self.graphicsView_hamming, self.graphicsView_rectangle)
        MainWindow.setTabOrder(self.graphicsView_rectangle, self.input_slider)
        MainWindow.setTabOrder(self.input_slider, self.grph_output_sig)
        MainWindow.setTabOrder(self.grph_output_sig, self.btn_zoom_out_input)
        MainWindow.setTabOrder(self.btn_zoom_out_input, self.graphicsView_hanning)
        MainWindow.setTabOrder(self.graphicsView_hanning, self.output_slider)
        MainWindow.setTabOrder(self.output_slider, self.btn_srt_begin_input)
        MainWindow.setTabOrder(self.btn_srt_begin_input, self.btn_play_output)
        MainWindow.setTabOrder(self.btn_play_output, self.btn_pause_output)
        MainWindow.setTabOrder(self.btn_pause_output, self.grph_input_sig)
...
""))
        ...
        self.std_lbl.setText(_translate("MainWindow", "1000"))
        ...
        self.label_35.setText(_translate("MainWindow", "triangle"))
        ...
        self.label_39.setText(_translate("MainWindow", "horse"))
        self.label_40.setText(_translate("MainWindow", "bat"))
        self.label_45.setText(_translate("MainWindow", "wolf"))
        self.label_46.setText(_translate("MainWindow", "duck"))
